...
# Used for enabling running of locally built images in kind without pushing to external location.
# Usage:
# docker build --tag localhost:5001/my-app:1.0 --push .
...
CLUSTER_NAME="${KIND_CLUSTER_NAME:-demo-cluster}"
