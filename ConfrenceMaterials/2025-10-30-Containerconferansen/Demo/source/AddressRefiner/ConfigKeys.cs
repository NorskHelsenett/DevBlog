...
{
    public const string ADDRESS_REFINER_STATE_STORAGE_TYPE = nameof(ADDRESS_REFINER_STATE_STORAGE_TYPE);
    public const string ADDRESS_REFINER_STATE_STORAGE_SQLITE_LOCATION_TYPE = nameof(ADDRESS_REFINER_STATE_STORAGE_SQLITE_LOCATION_TYPE);

    public const string ADDRESS_REFINER_KAFKA_TOPIC_RAW_ADDRESSES = nameof(ADDRESS_REFINER_KAFKA_TOPIC_RAW_ADDRESSES);
    public const string ADDRESS_REFINER_KAFKA_TOPIC_REFINED_ADDRESSES = nameof(ADDRESS_REFINER_KAFKA_TOPIC_REFINED_ADDRESSES);

    public const string ADDRESS_REFINER_KAFKA_READ_RAW_TOPIC_FROM_BEGINNING = nameof(ADDRESS_REFINER_KAFKA_READ_RAW_TOPIC_FROM_BEGINNING);
