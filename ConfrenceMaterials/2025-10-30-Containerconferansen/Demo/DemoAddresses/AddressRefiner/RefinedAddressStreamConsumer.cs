...
public class RefinedAddressStreamConsumer : BackgroundService
{
    ...
    public RefinedAddressStreamConsumer(ILogger<RefinedAddressStreamConsumer> logger, Meter meter, IAddressStorage addressStorage, IHostApplicationLifetime hostApplicationLifetime)
    {
        _logger = logger;
